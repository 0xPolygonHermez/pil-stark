...
const starkInfoGen = require("../../src/stark/helpers/stark_info.js")
...
describe("Stark Verification Circuit Test", function () {
    ...
    it("Should test circom circuit", async () => {
        ...
        const starkStructFile = path.join(__dirname, "../state_machines/sm_fibonacci", "fibonacci.starkstruct.json");
        ...
        const circuitSrc = await pil2circom(pil, constRoot, starkInfo, {arity: 4});
