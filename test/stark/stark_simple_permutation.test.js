...
const smSimplePermutation = require("../state_machines/sm_simple_permutation/sm_simple_permutation.js");
...
describe("test simple permutation sm", async function () {
    ...
    it("It should create the pols main", async () => {
        ...
        await smSimplePermutation.buildConstants(constPols.SimplePermutation);

        const cmPols = newCommitPolsArray(pil);

        await smSimplePermutation.execute(cmPols.SimplePermutation);

        console.log("CMPOLS", cmPols.SimplePermutation);
