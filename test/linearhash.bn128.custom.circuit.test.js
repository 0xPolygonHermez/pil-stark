...
describe("Linear Hash Circuit Test", function () {
    ...
    before( async() => {
        circuit = await wasm_tester(path.join(__dirname, "circuits", "linearhash.bn128.custom.test.circom"), {O:1, verbose:false, include: ["circuits.bn128.custom", "node_modules/circomlib/circuits"]});
        circuit100 = await wasm_tester(path.join(__dirname, "circuits", "linearhash100.bn128.custom.test.circom"), {O:1, verbose:false, include: ["circuits.bn128.custom", "node_modules/circomlib/circuits"]});
        circuit110 = await wasm_tester(path.join(__dirname, "circuits", "linearhash110.bn128.custom.test.circom"), {O:1, verbose:false, include: ["circuits.bn128.custom", "node_modules/circomlib/circuits"]});
    });
