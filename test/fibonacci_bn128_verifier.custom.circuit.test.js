...
describe("Fibonacci bn128 Verifier circuit Tester", function () {
    ...
    before( async() => {
        ...
        circuit = await wasm_tester(path.join(__dirname, "..", "tmp", "fibonacci.c12.verifier.circom"), {O:1, verbose:true, include: ["circuits.bn128.custom", "node_modules/circomlib/circuits"]});
    });
