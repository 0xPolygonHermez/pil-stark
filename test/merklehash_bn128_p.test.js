...
describe("merkle hash", async function () {
    ...
    it.skip("Big one (parallel) with arity 16", async () => {
        const N = 1<<17;
        const idx = 32;
        const nPols = 10;
    ...
    it.skip("Big one (parallel) with arity 4", async () => {
        const N = 1<<14;
        const idx = 32;
        const nPols = 31;
    ...
    it.skip("Should save and restore to file with arity 16", async() => {
        const N = 1<<18;
        const nPols = 10;
    ...
    it.skip("Should save and restore to file with arity 4", async() => {
        const N = 1<<14;
        const nPols = 10;
    ...
    it.skip("Should save and restore to file with arity 8", async() => {
        const N = 1<<14;
        const nPols = 10;
