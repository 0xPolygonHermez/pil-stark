...
module.exports.merkelize = function merkelize(vals, elementSize, elementsInLinear, nLinears) {
...
module.exports.getElement = function getElement(tree, idx, subIdx) {
...
module.exports.getGroupProof = function getGroupProof(tree, idx) {
    const elementSize = Number(tree[0]);
    const elementsInLinear = Number(tree[1]);
    const nLinears = Number(tree[2]);
    ...
    for (let i=0; i<elementsInLinear; i++) {
        v[i] = module.exports.getElement(tree, idx, i);
    }
...
module.exports.calculateRootFromGroupProof = function calculateRootFromGroupProof(mp, idx, vals) {
...
module.exports.eqRoot = function eqRoot(r1, r2) {
    const poseidon = buildPoseidon();
    for (let k=0; k<4; k++) {
...
module.exports.verifyGroupProof = function verifyGroupProof(root, mp, idx, groupElements) {
    const cRoot = module.exports.calculateRootFromGroupProof(mp, idx, groupElements);
    return module.exports.eqRoot(cRoot, root);
}

module.exports.root = function root(tree) {
    return [...tree.slice(-4)];
}
