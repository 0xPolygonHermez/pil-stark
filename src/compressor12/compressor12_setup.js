...
module.exports = async function plonkSetup(r1cs, options) {
    ...
    const C12PlonkConstraints = calculateC12PlonkConstraints(plonkConstraints);
    ...
    console.log(`Number of nEvPol4: ${customGatesInfo.nEvPol4} -> Constraints: ${customGatesInfo.nEvPol4*2}`);
    ...
    const NUsed = nPublicRows + C12PlonkConstraints + customGatesInfo.nCMulAdd + customGatesInfo.nPoseidon12*31 + customGatesInfo.nFFT4*2 + customGatesInfo.nEvPol4*2;
