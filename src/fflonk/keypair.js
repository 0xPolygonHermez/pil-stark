...
module.exports.hashToG2 = function (curve, hash) {
...
module.exports.getG2sp = function (curve, persinalization, challenge, g1s, g1sx) {
...
module.exports.createPTauKey = function (curve, challengeHash, rng) {
    const key = {
        tau: {},
        alpha: {},
        beta: {}
...
module.exports.createDeltaKey = function (curve, transcript, rng) {
    const delta = {};
