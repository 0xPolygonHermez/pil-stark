...
describe("Fflonk connection sm", async function () {
    ...
    it("It should create the pols main", async () => {
        ...
        fs.writeFileSync("./tmp/contracts/pilfflonk_verifier_connection.sol", verifierCode, "utf-8");
        fs.writeFileSync("./tmp/contracts/shplonk_verifier_connection.sol", verifierShPlonkCode, "utf-8");
