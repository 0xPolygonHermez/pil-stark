...
describe("Fflonk plookup sm", async function () {
    ...
    it("It should create the pols main", async () => {
        ...
        fs.writeFileSync("./tmp/contracts/pilfflonk_verifier_plookup.sol", verifierCode, "utf-8");
        fs.writeFileSync("./tmp/contracts/shplonk_verifier_plookup.sol", verifierShPlonkCode, "utf-8");
