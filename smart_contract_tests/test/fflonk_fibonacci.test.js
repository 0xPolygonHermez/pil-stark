...
describe("Fflonk Fibonacci sm", async function () {
    ...
    it("It should create the pols main", async () => {
        ...
        fs.writeFileSync("./tmp/contracts/pilfflonk_verifier_fibonacci.sol", verifierCode, "utf-8");
        fs.writeFileSync("./tmp/contracts/shplonk_verifier_fibonacci.sol", verifierShPlonkCode, "utf-8");
